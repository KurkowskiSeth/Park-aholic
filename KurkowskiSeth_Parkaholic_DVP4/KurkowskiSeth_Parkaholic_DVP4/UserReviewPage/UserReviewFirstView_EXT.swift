...
extension UserReview_ViewController {
    ...
    func createUI() {
        ...
        let animatedView = AnimatedViewClass()
        animatedView.translatesAutoresizingMaskIntoConstraints = false
        animatedView.backgroundColor = UIColor.blue
        
        view.addSubview(animatedView)
        
        animatedView.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 5).isActive = true
        animatedView.bottomAnchor.constraint(equalTo: nextBtn.topAnchor, constant: -30).isActive = true
        animatedView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 5).isActive = true
        animatedView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -5).isActive = true
        ...
        animatedView.addSubview(ratingHeader)
        
        ratingHeader.topAnchor.constraint(equalTo: animatedView.topAnchor, constant: 20).isActive = true
        ratingHeader.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 5).isActive = true
        ratingHeader.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -50).isActive = true
        ...
        //MARK: Park Quality
        let parkQualityRating = UIView()
        parkQualityRating.translatesAutoresizingMaskIntoConstraints = false
        parkQualityRating.backgroundColor = UIColor.red
        
        animatedView.addSubview(parkQualityRating)
        
        parkQualityRating.topAnchor.constraint(equalTo: ratingHeader.bottomAnchor, constant: 15).isActive = true
        parkQualityRating.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 10).isActive = true
        parkQualityRating.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -10).isActive = true
        parkQualityRating.heightAnchor.constraint(equalTo: ratingHeader.heightAnchor).isActive = true
        
        let parkQualityLbl = UILabel()
        parkQualityLbl.text = "Park Quality"
        parkQualityLbl.translatesAutoresizingMaskIntoConstraints = false
        
        parkQualityRating.addSubview(parkQualityLbl)
        
        parkQualityLbl.centerYAnchor.constraint(equalTo: parkQualityRating.centerYAnchor).isActive = true
        parkQualityLbl.leftAnchor.constraint(equalTo: parkQualityRating.leftAnchor, constant: 5).isActive = true
        
        createParkQualityButtons(pqView: parkQualityRating)
        
        //MARK: Park equipment
        let parkEquipmentRating = UIView()
        parkEquipmentRating.translatesAutoresizingMaskIntoConstraints = false
        parkEquipmentRating.backgroundColor = UIColor.red
        
        animatedView.addSubview(parkEquipmentRating)
        
        parkEquipmentRating.topAnchor.constraint(equalTo: parkQualityRating.bottomAnchor, constant: 15).isActive = true
        parkEquipmentRating.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 10).isActive = true
        parkEquipmentRating.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -10).isActive = true
        parkEquipmentRating.heightAnchor.constraint(equalTo: parkQualityRating.heightAnchor).isActive = true
        ...
        parkEquipmentRating.addSubview(parkEquipmentLbl)
        
        parkEquipmentLbl.centerYAnchor.constraint(equalTo: parkEquipmentRating.centerYAnchor).isActive = true
        parkEquipmentLbl.leftAnchor.constraint(equalTo: parkEquipmentRating.leftAnchor, constant: 5).isActive = true
        
        createParkEquipmentButtons(peView: parkEquipmentRating)
        
        //MARK: Neighborhood
        let neighborhoodRating = UIView()
        neighborhoodRating.translatesAutoresizingMaskIntoConstraints = false
        neighborhoodRating.backgroundColor = UIColor.red
        
        animatedView.addSubview(neighborhoodRating)
        
        neighborhoodRating.topAnchor.constraint(equalTo: parkEquipmentRating.bottomAnchor, constant: 15).isActive = true
        neighborhoodRating.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 10).isActive = true
        neighborhoodRating.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -10).isActive = true
        neighborhoodRating.heightAnchor.constraint(equalTo: parkEquipmentRating.heightAnchor).isActive = true
        ...
        neighborhoodRating.addSubview(neighborhoodLbl)
        
        neighborhoodLbl.centerYAnchor.constraint(equalTo: neighborhoodRating.centerYAnchor).isActive = true
        neighborhoodLbl.leftAnchor.constraint(equalTo: neighborhoodRating.leftAnchor, constant: 5).isActive = true
        
        createNeighborhoodButtons(pnView: neighborhoodRating)
        
        //MARK: Overall Enjoyment
        let overallEnjoymentRating = UIView()
        overallEnjoymentRating.translatesAutoresizingMaskIntoConstraints = false
        overallEnjoymentRating.backgroundColor = UIColor.red
        
        animatedView.addSubview(overallEnjoymentRating)
        
        overallEnjoymentRating.topAnchor.constraint(equalTo: neighborhoodRating.bottomAnchor, constant: 15).isActive = true
        overallEnjoymentRating.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 10).isActive = true
        overallEnjoymentRating.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -10).isActive = true
        overallEnjoymentRating.heightAnchor.constraint(equalTo: neighborhoodRating.heightAnchor).isActive = true
        ...
        overallEnjoymentRating.addSubview(overallEnjoymentLbl)
        
        overallEnjoymentLbl.centerYAnchor.constraint(equalTo: overallEnjoymentRating.centerYAnchor).isActive = true
        overallEnjoymentLbl.leftAnchor.constraint(equalTo: overallEnjoymentRating.leftAnchor, constant: 5).isActive = true
        
        createEnjoymentButtons(poeView: overallEnjoymentRating)
        
        //MARK: Likeliness to Return
        let likelinessToReturnRating = UIView()
        likelinessToReturnRating.translatesAutoresizingMaskIntoConstraints = false
        likelinessToReturnRating.backgroundColor = UIColor.red
        
        animatedView.addSubview(likelinessToReturnRating)
        
        likelinessToReturnRating.topAnchor.constraint(equalTo: overallEnjoymentRating.bottomAnchor, constant: 15).isActive = true
        likelinessToReturnRating.leftAnchor.constraint(equalTo: animatedView.leftAnchor, constant: 10).isActive = true
        likelinessToReturnRating.rightAnchor.constraint(equalTo: animatedView.rightAnchor, constant: -10).isActive = true
        likelinessToReturnRating.heightAnchor.constraint(equalTo: overallEnjoymentRating.heightAnchor).isActive = true
        ...
        likelinessToReturnRating.addSubview(likelinessToReturnLbl)
        
        likelinessToReturnLbl.centerYAnchor.constraint(equalTo: likelinessToReturnRating.centerYAnchor).isActive = true
        likelinessToReturnLbl.leftAnchor.constraint(equalTo: likelinessToReturnRating.leftAnchor, constant: 5).isActive = true
        
        //TODO: - Add rating stars here for likeliness to return
        createLikelinessToReturnButtons(plrView: likelinessToReturnRating)
    ...
    */
    ...
    func createParkQualityButtons(pqView: UIView) {
        ...
        //Button 1
        pQBtn1.tag = 11
        pQBtn1.setImage(#imageLiteral(resourceName: "star_Empty"), for: .normal)
    ...
    func createParkEquipmentButtons(peView: UIView) {
        ...
        //Button 1
        pEBtn1.tag = 21
        pEBtn1.setImage(#imageLiteral(resourceName: "star_Empty"), for: .normal)
    ...
    func createNeighborhoodButtons(pnView: UIView) {
        ...
        //Button 1
        pNBtn1.tag = 31
        pNBtn1.setImage(#imageLiteral(resourceName: "star_Empty"), for: .normal)
    ...
    func createEnjoymentButtons(poeView: UIView) {
        ...
        //Button 1
        pOEBtn1.tag = 41
        pOEBtn1.setImage(#imageLiteral(resourceName: "star_Empty"), for: .normal)
    ...
    func createLikelinessToReturnButtons(plrView: UIView) {
        ...
        //Button 1
        pLRBtn1.tag = 51
        pLRBtn1.setImage(#imageLiteral(resourceName: "star_Empty"), for: .normal)
