...
extension ViewController {
    ...
    func createHambugerMenu() {
        ...
        hamburgerMenuContentView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.2).isActive = true
        ...
        signOutInBtn.topAnchor.constraint(equalTo: favoritesBtn.bottomAnchor, constant: 15).isActive = true
        signOutInBtn.heightAnchor.constraint(equalTo: favoritesBtn.heightAnchor).isActive = true
        signOutInBtn.centerXAnchor.constraint(equalTo: favoritesBtn.centerXAnchor).isActive = true
        signOutInBtn.widthAnchor.constraint(equalTo: favoritesBtn.widthAnchor).isActive = true
    }
}
